  ...
  void onExit() {
    if (_canRedirect) {
      Navigator.pushReplacementNamed(context,
          '${Routes.ORDER_SUCCESS_SCREEN}/${orderModel.id}/payment-fail');
    }
    ...
    if (_canRedirect) {
      ...
      if (_isSuccess) {
        String _token = url.replaceAll(
            '${AppConstants.BASE_URL}${Routes.ORDER_SUCCESS_SCREEN}/success?token=',
            '');
        if (_token != null) {
          String _decodeValue =
        ...
        Navigator.pushReplacementNamed(context,
            '${Routes.ORDER_SUCCESS_SCREEN}/${orderModel.id}/payment-cancel');
      }
    }
  }
