...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void initState() {
    ...
    if (_isLoggedIn) {
      ...
      DateTime _open = DateFormat('HH:mm')
          .parse(_configModel.restaurantScheduleTime.first.openingTime);
      DateTime _close = DateFormat('HH:mm')
          .parse(_configModel.restaurantScheduleTime.first.closingTime);
                                                                      ...
                                                                      return SlotWidget(
                                                                        title: (index == 0 &&
                                                                            ...
                                                                            : '${DateConverter.dateToTimeOnly(
                                                                                order.timeSlots[index].startTime,
                                                                                context,
                                                                              )} '
                                                                                '- ${DateConverter.dateToTimeOnly(
                                                                                order.timeSlots[index].endTime,
                                                                                context,
                                                                              )}',
                                                                        isSelected:
