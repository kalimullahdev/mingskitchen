              ...
              builder: (context, productProvider, child) {
                ...
                for (int index = 0; index < product.addOns.length; index++) {
                  if (productProvider.addOnActiveList[index]) {
                    ...
                    print('price With addons test $index : $addonsCost');
                  }
                }
                ...
                isExistInCart = _cartProvider.isExistInCart(
                    _cartModel, fromCart, cartIndex);
                double priceWithQuantity = isExistInCart
                    ? priceWithDiscount *
                        _cartProvider
                            .cartList[
                                _cartProvider.getCartProductIndex(_cartModel)]
                            .quantity
                                ...
                                onTap: () {
                                  if (isExistInCart &&
                                    ...
                                    _cartProvider.setQuantity(
                                        productIndex: _cartProvider
                                            .getCartProductIndex(_cartModel),
                                        cart: _cartModel,
                                        fromProductView: true,
                                        isIncrement: false);
                                  } else {
                                  ...
                                  _isAvailable
                                      ...
                                      : Container(
                                          ...
                                          child: Column(children: [
                                            ...
                                            Text(
                                              '${getTranslated('available_will_be', context)} ${DateConverter.convertTimeToTime(
